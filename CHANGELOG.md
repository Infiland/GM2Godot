...
- Kept native receipt hashes bound to the exact generated bytes and continued rejecting every non-newline content, provenance, pin, and ordering difference.
- Added executable LF, CRLF, lone-CR, and content-mutation coverage while preserving GameMaker LTS 2026 conversion behavior and exact Godot 4.7.1 output.
