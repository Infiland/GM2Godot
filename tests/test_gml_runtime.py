...
RUNTIME_VALUE_PARITY_CASES: tuple[RuntimeValueParityCase, ...] = (
    ...
    RuntimeValueParityCase(
        "distance_to_object(o_enemy)",
        'GMRuntime.gml_distance_to_object(self, GMRuntime.gml_asset_get_index("o_enemy"))',
    ),
    RuntimeValueParityCase(
        "matrix_build_lookat(0, 0, -10, 0, 0, 0, 0, 1, 0)",
        "GMRuntime.gml_matrix_build_lookat(0, 0, -10, 0, 0, 0, 0, 1, 0)",
    ),
    RuntimeValueParityCase(
        "matrix_build_projection_ortho(320, 180, 1, 1000)",
        "GMRuntime.gml_matrix_build_projection_ortho(320, 180, 1, 1000)",
    ),
    RuntimeValueParityCase("make_color_rgb(255, 128, 0)", "GMRuntime.gml_make_color_rgb(255, 128, 0)"),
    ...
    RuntimeValueParityCase("draw_line_width(0, 1, 2, 3, 4)", "GMRuntime.gml_draw_line_width(0, 1, 2, 3, 4)"),
    RuntimeValueParityCase("draw_rectangle(0, 0, 10, 20, false)", "GMRuntime.gml_draw_rectangle(0, 0, 10, 20, false)"),
    RuntimeValueParityCase(
        "draw_rectangle_color(0, 0, 10, 20, c_red, c_white, c_blue, c_black, false)",
        "GMRuntime.gml_draw_rectangle_color(0, 0, 10, 20, 0x0000ff, 0xffffff, 0xff0000, 0x000000, false)",
    ),
    ...
    RuntimeValueParityCase("camera_create()", "GMRuntime.gml_camera_create()"),
    RuntimeValueParityCase(
    ...
    RuntimeValueParityCase("camera_destroy(cam)", "GMRuntime.gml_camera_destroy(cam)"),
    RuntimeValueParityCase("camera_apply(cam)", "GMRuntime.gml_camera_apply(cam)"),
    RuntimeValueParityCase("camera_get_active()", "GMRuntime.gml_camera_get_active()"),
    ...
    RuntimeValueParityCase("view_get_camera(0)", "GMRuntime.gml_view_get_camera(0)"),
    RuntimeValueParityCase("view_set_camera(0, cam)", "GMRuntime.gml_view_set_camera(0, cam)"),
    RuntimeValueParityCase("view_get_surface_id(0)", "GMRuntime.gml_view_get_surface_id(0)"),
    RuntimeValueParityCase("view_set_surface_id(0, surf)", "GMRuntime.gml_view_set_surface_id(0, surf)"),
    RuntimeValueParityCase("view_get_visible(1)", "GMRuntime.gml_view_get_visible(1)"),
    RuntimeValueParityCase("view_set_visible(1, true)", "GMRuntime.gml_view_set_visible(1, true)"),
    RuntimeValueParityCase("view_get_xport(1)", "GMRuntime.gml_view_get_xport(1)"),
    RuntimeValueParityCase("view_get_yport(1)", "GMRuntime.gml_view_get_yport(1)"),
    RuntimeValueParityCase("view_get_wport(1)", "GMRuntime.gml_view_get_wport(1)"),
    RuntimeValueParityCase("view_get_hport(1)", "GMRuntime.gml_view_get_hport(1)"),
    RuntimeValueParityCase("view_set_xport(1, 320)", "GMRuntime.gml_view_set_xport(1, 320)"),
    RuntimeValueParityCase("view_set_yport(1, 20)", "GMRuntime.gml_view_set_yport(1, 20)"),
    RuntimeValueParityCase("view_set_wport(1, 640)", "GMRuntime.gml_view_set_wport(1, 640)"),
    RuntimeValueParityCase("view_set_hport(1, 360)", "GMRuntime.gml_view_set_hport(1, 360)"),
    ...
    RuntimeValueParityCase("display_set_gui_maximise()", "GMRuntime.gml_display_set_gui_maximise()"),
    RuntimeValueParityCase("display_set_gui_maximise(0.5, 0.5, 2, 4)", "GMRuntime.gml_display_set_gui_maximise(0.5, 0.5, 2, 4)"),
    RuntimeValueParityCase("display_get_width()", "GMRuntime.gml_display_get_width()"),
    RuntimeValueParityCase("display_get_height()", "GMRuntime.gml_display_get_height()"),
    RuntimeValueParityCase("display_get_dpi_x()", "GMRuntime.gml_display_get_dpi_x()"),
    RuntimeValueParityCase("display_get_dpi_y()", "GMRuntime.gml_display_get_dpi_y()"),
    RuntimeValueParityCase("display_get_orientation()", "GMRuntime.gml_display_get_orientation()"),
    RuntimeValueParityCase("display_set_orientation(0)", "GMRuntime.gml_display_set_orientation(0)"),
    RuntimeValueParityCase("display_get_frequency()", "GMRuntime.gml_display_get_frequency()"),
    RuntimeValueParityCase("display_reset(0, false)", "GMRuntime.gml_display_reset(0, false)"),
    RuntimeValueParityCase("display_get_timing_method()", "GMRuntime.gml_display_get_timing_method()"),
    RuntimeValueParityCase("display_set_timing_method(tm_sleep)", "GMRuntime.gml_display_set_timing_method(0)"),
    RuntimeValueParityCase("display_get_sleep_margin()", "GMRuntime.gml_display_get_sleep_margin()"),
    RuntimeValueParityCase("display_set_sleep_margin(12)", "GMRuntime.gml_display_set_sleep_margin(12)"),
    RuntimeValueParityCase("display_mouse_set(10, 20)", "GMRuntime.gml_display_mouse_set(10, 20)"),
    RuntimeValueParityCase("display_set_ui_visibility(0)", "GMRuntime.gml_display_set_ui_visibility(0)"),
    RuntimeValueParityCase("window_center()", "GMRuntime.gml_window_center()"),
    RuntimeValueParityCase("window_get_fullscreen()", "GMRuntime.gml_window_get_fullscreen()"),
    RuntimeValueParityCase("window_get_width()", "GMRuntime.gml_window_get_width()"),
    RuntimeValueParityCase("window_get_height()", "GMRuntime.gml_window_get_height()"),
    RuntimeValueParityCase("window_get_x()", "GMRuntime.gml_window_get_x()"),
    RuntimeValueParityCase("window_get_y()", "GMRuntime.gml_window_get_y()"),
    RuntimeValueParityCase("window_get_visible_rects()", "GMRuntime.gml_window_get_visible_rects()"),
    RuntimeValueParityCase("window_mouse_get_x()", "GMRuntime.gml_window_mouse_get_x()"),
    RuntimeValueParityCase("window_mouse_get_y()", "GMRuntime.gml_window_mouse_get_y()"),
    RuntimeValueParityCase("window_mouse_set(11, 22)", "GMRuntime.gml_window_mouse_set(11, 22)"),
    RuntimeValueParityCase("window_view_mouse_get_x(1)", "GMRuntime.gml_window_view_mouse_get_x(1)"),
    RuntimeValueParityCase("window_view_mouse_get_y(1)", "GMRuntime.gml_window_view_mouse_get_y(1)"),
    RuntimeValueParityCase("window_views_mouse_get_x()", "GMRuntime.gml_window_views_mouse_get_x()"),
    RuntimeValueParityCase("window_views_mouse_get_y()", "GMRuntime.gml_window_views_mouse_get_y()"),
    RuntimeValueParityCase("window_set_fullscreen(false)", "GMRuntime.gml_window_set_fullscreen(false)"),
    ...
    RuntimeValueParityCase("window_set_max_height(1500)", "GMRuntime.gml_window_set_max_height(1500)"),
    RuntimeValueParityCase("window_minimise()", "GMRuntime.gml_window_minimise()"),
    RuntimeValueParityCase("window_restore()", "GMRuntime.gml_window_restore()"),
    RuntimeValueParityCase('screen_save("shot.png")', 'GMRuntime.gml_screen_save("shot.png")'),
    RuntimeValueParityCase('screen_save_part("shot_part.png", 0, 0, 8, 8)', 'GMRuntime.gml_screen_save_part("shot_part.png", 0, 0, 8, 8)'),
...
class TestGMLRuntimeScript(unittest.TestCase):
    def test_runtime_defines_shared_value_helpers(self):
        helper_names: tuple[str, ...] = (
            ...
            "gml_view_get_camera",
            "gml_view_set_camera",
            "gml_view_get_surface_id",
            "gml_view_set_surface_id",
            "gml_view_get_visible",
            "gml_view_set_visible",
            "gml_view_get_xport",
            "gml_view_get_yport",
            "gml_view_get_wport",
            "gml_view_get_hport",
            ...
            "gml_view_set_wport",
            "gml_view_set_hport",
            "gml_view_backend_diagnostics",
            "gml_display_get_gui_width",
            "gml_display_get_gui_height",
            "gml_display_set_gui_size",
            "gml_display_set_gui_maximise",
            "gml_display_get_width",
            "gml_display_get_height",
            "gml_display_get_dpi_x",
            "gml_display_get_dpi_y",
            "gml_display_get_orientation",
            "gml_display_set_orientation",
            "gml_display_get_frequency",
            "gml_display_reset",
            "gml_display_get_timing_method",
            "gml_display_get_sleep_margin",
            "gml_display_set_ui_visibility",
            "gml_display_set_timing_method",
            "gml_display_set_sleep_margin",
            "gml_display_mouse_set",
            "gml_window_center",
            "gml_window_get_fullscreen",
            "gml_window_get_width",
            "gml_window_get_height",
            "gml_window_get_x",
            "gml_window_get_y",
            "gml_window_get_visible_rects",
            "gml_window_mouse_get_x",
            "gml_window_mouse_get_y",
            "gml_window_mouse_set",
            "gml_window_view_mouse_get_x",
            "gml_window_view_mouse_get_y",
            "gml_window_views_mouse_get_x",
            "gml_window_views_mouse_get_y",
            "gml_window_set_fullscreen",
            "gml_window_set_position",
            "gml_window_set_size",
            "gml_window_set_rectangle",
            "gml_window_set_min_width",
            "gml_window_set_max_width",
            "gml_window_set_min_height",
            "gml_window_set_max_height",
            "gml_window_minimise",
            "gml_window_restore",
            "gml_screen_save",
            "gml_screen_save_part",
            "gml_keyboard_check",
            ...
            "gml_video_close",
            "gml_video_draw",
            "gml_video_set_volume",
            "gml_video_pause",
            "gml_video_resume",
            "gml_video_enable_loop",
            "gml_video_seek_to",
            "gml_video_is_looping",
            "gml_video_get_volume",
            "gml_video_get_duration",
            "gml_video_get_position",
            "gml_video_get_status",
            "gml_video_get_format",
            "gml_shader_set",
            "gml_shader_reset",
            "gml_shader_get_name",
    ...
    def test_runtime_audio_helpers_use_sound_handles_and_asset_metadata(self):
        ...
        self.assertIn("static var _gml_audio_emitters = {}", GML_RUNTIME_SCRIPT)
        self.assertIn("static var _gml_audio_queues = {}", GML_RUNTIME_SCRIPT)
        self.assertIn("static var _gml_audio_sync_groups = {}", GML_RUNTIME_SCRIPT)
        ...
        self.assertIn("static func gml_audio_play_sound_at(sound, x, y, z, falloff_ref, falloff_max, falloff_factor, loop, priority, gain = null, offset = null, pitch = null, listener_mask = null):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_play_sound_on(emitter, sound, loop, priority, gain = null, offset = null, pitch = null, listener_mask = null):", GML_RUNTIME_SCRIPT)
        ...
        self.assertIn("static func gml_audio_stop_all():", GML_RUNTIME_SCRIPT)
        ...
        self.assertIn("static func gml_audio_sound_get_gain(sound):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_sound_pitch(sound, pitch):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_emitter_create():", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_create_play_queue(queue_format, queue_rate, queue_channels):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_start_recording(recorder_index):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func gml_audio_create_sync_group(loop):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func _gml_audio_player_is_valid(player):", GML_RUNTIME_SCRIPT)
        self.assertIn("static func _gml_audio_enforce_channel_limit():", GML_RUNTIME_SCRIPT)
