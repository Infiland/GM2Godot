...
class Converter:
    ...
    def convert(self, gm_path, godot_path, settings):
        ...
        converters = [
            ...
            ("project_name", project_settings_converter.update_project_name, get_localized("Console_Convertor_Name")),
            ("project_settings", project_settings_converter.update_project_settings, get_localized("Console_Convertor_Settings")),
            ("audio_buses", project_settings_converter.generate_audio_bus_layout, get_localized("Console_Convertor_AudioBus")),
        ...
        self.log(get_localized("Console_ConversionComplete"))
