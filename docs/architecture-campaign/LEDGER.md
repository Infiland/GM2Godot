...
| R11 Authoritative project resource model | implementing | audit_gml_resources; accepted parent `ec25791` | Contract independently and root approved; actual-code review required | R11-project-model-contract.md; exact final source/import/metric refresh verified; conditional isolated entry |
