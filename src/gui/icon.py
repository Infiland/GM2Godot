...
class Icon:
    def __init__(self, master):
        ...
        self.gm_icon = self.load_icon("img/Gamemaker.png", 20)
        self.godot_icon = self.load_icon("img/Godot.png", 20)
        self.language_icon = self.load_icon("img/icon_language.png", 60)
    ...
    def load_icon(self, path, scale):
        try:
            ...
            return ImageTk.PhotoImage(img.resize((scale, scale), Image.Resampling.LANCZOS))
        except Exception as e:
