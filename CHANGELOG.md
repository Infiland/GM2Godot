...
- Added malformed and bounded-parser coverage, old/new-format interruption recovery at every publication boundary, and a changed 10,000-file generation whose 13,866,493-byte commit record publishes and recovers under exact Godot 4.7.1 and GameMaker LTS 2026 validation.
